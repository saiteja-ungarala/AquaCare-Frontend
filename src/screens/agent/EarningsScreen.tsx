...
const styles = StyleSheet.create({
    ...
    earningsLabel: { ...typography.body, color: colors.secondaryLight },
    earningsAmount: { ...typography.h1, color: colors.textOnPrimary, fontWeight: '700', fontSize: 40, marginVertical: spacing.sm },
    periodTabs: { flexDirection: 'row', backgroundColor: colors.glassSurface, borderRadius: borderRadius.md, padding: 4 },
    ...
    periodTabText: { ...typography.bodySmall, color: colors.secondaryLight },
