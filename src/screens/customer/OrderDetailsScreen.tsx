...
export const OrderDetailsScreen: React.FC<OrderDetailsScreenProps> = ({ navigation, route }) => {
    ...
    const { selectedOrder, isLoadingDetail, fetchOrderById, clearSelectedOrder } = useOrdersStore();
                ...
                <View style={styles.sectionCard}>
                    <View style={styles.topRow}>
                        ...
                        <View style={[styles.badge, { backgroundColor: `${statusColor}20` }]}>
                            <Text style={[styles.badgeText, { color: statusColor }]}>{getStatusLabel(selectedOrder.status)}</Text>
                        </View>
                    </View>
                    ...
                    {selectedOrder.items.map((item) => (
                        <View key={item.id} style={styles.itemRow}>
                            ...
                            <View style={styles.itemInfo}>
                                ...
                                <Text style={styles.itemMeta}>Qty: {item.qty} x {formatCurrency(item.unitPrice)}</Text>
                            </View>
...
const styles = StyleSheet.create({
    ...
    sectionCard: { backgroundColor: colors.surface, borderRadius: borderRadius.lg, padding: spacing.md, marginBottom: spacing.md, ...shadows.sm },
