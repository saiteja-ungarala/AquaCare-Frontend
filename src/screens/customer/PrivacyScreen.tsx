...
const SECTIONS = [
    ...
    { title: '4. Third-Party Sharing', body: 'We may share limited information with service technicians assigned to your bookings, payment processors, and analytics providers. All third parties are bound by strict data protection agreements.' },
